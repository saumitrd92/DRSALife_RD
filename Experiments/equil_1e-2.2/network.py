...
def loss_reconpsi(y_true, y_pred):
    global my_args
    state_features, enc_inputs, reconphi, reconpsi, psi_encoder = my_args
...
def custom_loss(y_true, y_pred):
    ...
    L_total = (w_recon*L_recon_phi + w_recon*L_recon_psi)*0.5 + w_pred*L_pred + w_inf*L_infinity #+ w_lin*L_linear 
...
#     nn1 = Dense(32, activation="relu", name='complex_lam_{}_dense1'.format(i+1), kernel_regularizer=L1L2(l1=params_g['hp_l1_reg'], l2=params_g['hp_l2_reg']))(nn_input)
#     nn2 = Dense(32, activation="relu", name='complex_lam_{}_dense2'.format(i+1), kernel_regularizer=L1L2(l1=params_g['hp_l1_reg'], l2=params_g['hp_l2_reg']))(nn1)
#     nn5 = Dense(2, activation="relu", name='complex_lam_{}_output'.format(i+1), kernel_regularizer=L1L2(l1=params_g['hp_l1_reg'], l2=params_g['hp_l2_reg']))(nn2)
#     nn = Model(nn_input, nn5)
#     return nn

# def lamda_nn_real(input_features,i):
#     global params_g
#     nn_input = Input(tensor=input_features, name='real_lam_{}_input'.format(i+1))
#     nn1 = Dense(32, activation="relu", name='real_lam_{}_dense1'.format(i+1), kernel_regularizer=L1L2(l1=params_g['hp_l1_reg'], l2=params_g['hp_l2_reg']))(nn_input)
#     nn2 = Dense(32, activation="relu", name='real_lam_{}_dense2'.format(i+1), kernel_regularizer=L1L2(l1=params_g['hp_l1_reg'], l2=params_g['hp_l2_reg']))(nn1)
#     nn5 = Dense(1, activation="relu", name='real_lam_{}_output'.format(i+1), kernel_regularizer=L1L2(l1=params_g['hp_l1_reg'], l2=params_g['hp_l2_reg']))(nn2)
#     nn = Model(nn_input, nn5)
#     return nn
...
def pipeline(params):
    ...
    h = params['hp_latent_space'] #num_real + 2*num_complex_pairs
    ...
    beta_dense1 = Dense(params['hp_beta_units'], activation="relu", name='beta_dense1')(beta_inputs)
    beta_dense2 = Dense(params['hp_beta_units'], activation="relu", name='beta_dense2')(beta_dense1)
    # beta_dense3 = Dense(params['hp_beta_units'], activation="relu", name='beta_dense3')(beta_dense2)
    beta_dense4 = Dense(k*state_features, activation="tanh", name='beta_dense4')(beta_dense2)
    # beta_flatten = Flatten()(beta_dense4)

    concat_enc_inputs = Lambda(lambda z: tf.concat(z,axis=-1), name='concat')([enc_inputs,beta_dense4])

    ### Add Phi Encoder ###
    phi_enc_dense1 = Dense(params['hp_phi_enc_units'], activation="relu", name='phi_enc_dense1')(concat_enc_inputs)
    phi_enc_dense21 = Dense(params['hp_phi_enc_units'], activation="relu", name='phi_enc_dense21')(phi_enc_dense1)
    # phi_enc_dense22 = Dense(params['hp_phi_enc_units'], activation="relu", name='phi_enc_dense22')(phi_enc_dense21)
    phi_enc_dense3 = Dense(h, activation="relu", name='phi_enc_dense3')(phi_enc_dense21)
    phi_encoder = Model([enc_inputs,beta_inputs], phi_enc_dense3, name='phi_Encoder')

    ### Add Psi Encoder ###
    psi_enc_dense1 = Dense(params['hp_psi_enc_units'], activation="relu", name='psi_enc_dense1')(enc_inputs)
    psi_enc_dense21 = Dense(params['hp_psi_enc_units'], activation="relu", name='psi_enc_dense21')(psi_enc_dense1)
    # psi_enc_dense22 = Dense(params['hp_psi_enc_units'], activation="relu", name='psi_enc_dense22')(psi_enc_dense21)
    psi_enc_dense3 = Dense(h, activation="relu", name='psi_enc_dense3')(psi_enc_dense21)
    ...
    psi_dec_dense1 = Dense(params['hp_psi_dec_units'], activation="relu", name='psi_dec_dense1')(psi_dec_inputs)
    psi_dec_dense21 = Dense(params['hp_psi_dec_units'], activation="relu", name='psi_dec_dense21')(psi_dec_dense1)
    # psi_dec_dense22 = Dense(params['hp_psi_dec_units'], activation="relu", name='psi_dec_dense22')(psi_dec_dense21)
    psi_dec_dense3 = Dense(state_features, activation="tanh", name='psi_dec_dense3')(psi_dec_dense21)
    ...
    delta_dense1 = Dense(params['hp_delta_units'], activation="relu", name='delta_dense1')(delta_inputs)
    delta_dense21 = Dropout(params['hp_dropout'])(Dense(params['hp_delta_units'], activation="relu", name='delta_dense21')(delta_dense1))
    ...
    predx = delta_net(phi_encoder([enc_inputs,beta_inputs]))

    global my_args

    my_args = state_features, enc_inputs, reconphi, reconpsi, psi_encoder#, linearx
    ...
    pipeline_nn.compile(loss=custom_loss, optimizer=opt, metrics=[loss_reconphi,loss_reconpsi,loss_pred,loss_infinity,custom_loss,loss_recon])
